package com.zeus.group_languages.controllers;
...
import com.zeus.group_languages.services.LanguageService;
...
public class HomeController {
	...
	public String Language(@PathVariable("id") int id, Model model) {
		Crud language= languageService.findlLanguageBYIndex(id);
		if (language != null) {
